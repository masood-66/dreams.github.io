<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KeyWords.aspx.cs" Inherits="Islamic_Dreams.KeysWords" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
					...
					<div class="row">
						<div class="col-md-2" style="font-size: 15.5px; font-weight: bold;">
							<div class="form-group" style="margin-top: 6px;">
								<asp:Label runat="server" Text="Reference Book" />
							</div>
						</div>
						...
						<ItemTemplate>
							<tr>
								...
								<td  class="text-wrap" style="width: 40%">
									<asp:Label runat="server" Text='<%#Eval("KEY_ENGLISH") %>' /></td>
								<td  class="text-wrap" style="width: 40%">
									<asp:Label runat="server" Text='<%#Eval("KEY_URDU") %>' /></td>
								<%--<td><asp:Label runat="server" Text='<%#Eval("BOOK_ENG") %>' /></td>--%>
								<td style="width: 20%">
									...
									<ul class="list-inline m-0">
										...
										<li class="list-inline-item">
											<asp:LinkButton runat="server" ID="edit" CommandName="Edit" CommandArgument='<%#Eval("KEY_CODE") %>' class="btn btn-success btn-sm rounded-0"><i class="fa fa-edit"></i></asp:LinkButton>

										</li>
										<li class="list-inline-item">
											<asp:LinkButton runat="server" ID="Delete" CommandName="Delete" CommandArgument='<%#Eval("KEY_CODE") %>' class="btn btn-danger btn-sm rounded-0"><i class="fa fa-trash"></i></asp:LinkButton>
										</li>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title mt-0" id="myLargeModalLabel">Add Keyword</h5>
						...
						<div class="card-body">
							...
							<div class="needs-validation" novalidate="">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="txtEnglish">Keyword English</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="txtUrdu">Keyword Urdu</label>
	...
	<div class="modal fade bs-example-modal-lg" id="UpdateModel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title mt-0" id="myLargeModalLabel1">Update Keyword</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close" runat="server" onserverclick="btnNo_OnClick">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
						...
						<div class="card-body">
							...
							<div class="needs-validation" novalidate="">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label for="txtEnglish">Select Book Reference</label>
											<asp:DropDownList runat="server" ID="ddlBookReffUpdate" CssClass="form-control" />
