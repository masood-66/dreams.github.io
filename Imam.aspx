<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Imam.aspx.cs" Inherits="Islamic_Dreams.Imam" %>
							...
							<asp:Repeater runat="server" ID="rptKey" OnItemCommand="rptKey_OnItemCommand" >
								...
								<ItemTemplate>
									<tr>
										...
										<td class="text-wrap" style="width: 40%">
											<asp:Label runat="server" Text='<%#Eval("IMAM_URDU") %>' /></td>
										...
										<td style="width: 20%">
											...
											<ul class="list-inline m-0">
												...
												<li class="list-inline-item">
													<asp:LinkButton runat="server" ID="edit" CommandName="Edit" CommandArgument='<%#Eval("IMAM_ID") %>' class="btn btn-success btn-sm rounded-0"><i class="fa fa-edit"></i></asp:LinkButton>

												</li>
												<li class="list-inline-item">
													<asp:LinkButton runat="server" ID="Delete" CommandName="Delete" CommandArgument='<%#Eval("IMAM_ID") %>' class="btn btn-danger btn-sm rounded-0"><i class="fa fa-trash"></i></asp:LinkButton>
												</li>
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title mt-0" id="myLargeModalLabel">Add Imam Information </h5>
									...
									<div class="needs-validation" novalidate="">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="txtEnglish">Imam Name in English</label>
													<asp:TextBox runat="server" ID="txtEnglish" CssClass="form-control" placeholder="Enter Imam Name in English" TextMode="MultiLine" Rows="2" />
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="txtUrdu">
														اردو میں امام کا نام
													</label>
													<asp:TextBox runat="server" ID="txtUrdu" CssClass="form-control text-right" placeholder="امام کا نام لکھیں" TextMode="MultiLine" Rows="2" />
													<div class="valid-feedback">
														Looks good!
													</div>
												</div>
